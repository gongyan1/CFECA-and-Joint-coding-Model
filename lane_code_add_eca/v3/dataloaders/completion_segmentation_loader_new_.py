...
#             return pnew
        ...
        if args.val == "select":
            ...
            glob_pc = os.path.join(
                args.data_folder,
                #'data_depth_velodyne/train/*_sync/proj_depth/velodyne_raw/image_0[2,3]/*.png'
                # '/home/linux/data/new_data/small_data/val/knn_pc/*.png'
                '/home/first/桌面/gongyan/small_data/val/knn_pc/*.png'
            )
            ...
            glob_road_label = os.path.join(
                args.data_folder,
                #'data_depth_annotated/train/*_sync/proj_depth/groundtruth/image_0[2,3]/*.png'
                # '/home/linux/data/new_data/small_data/val/road_label/*.png'
                '/home/first/桌面/gongyan/small_data/val/road_label/*.png'
            )
            ...
            glob_lane_label = os.path.join(
                args.data_folder,
                #'data_depth_annotated/train/*_sync/proj_depth/groundtruth/image_0[2,3]/*.png'
                # '/home/linux/data/new_data/small_data/val/lane_label/*.png'
                '/home/first/桌面/gongyan/small_data/val/lane_label/*.png'
            )
