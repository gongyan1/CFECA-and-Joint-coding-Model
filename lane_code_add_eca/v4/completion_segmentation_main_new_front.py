...
# from completion_segmentation_model_v4_sk_attention import DepthCompletionFrontNet
# from completion_segmentation_model_v4_attention_2 import DepthCompletionFrontNet



# from completion_segmentation_model_v4_eca_attention import DepthCompletionFrontNet

from completion_segmentation_model_v4_eca_attention_2 import DepthCompletionFrontNet
...
args.result = os.path.join('..', 'result/v4/train_sk_2')
