...
from completion_segmentation_model_v4_sk_attention_2 import DepthCompletionFrontNet
...
parser.add_argument('-e', '--evaluate', default='/home/linux/Program/lane_segmentation/result/v4/train_sk_2/train_20epoch/model_best.pth.tar', type=str, metavar='PATH')
parser.add_argument('--cpu', action="store_true", help='run on cpu')

args = parser.parse_args()
args.use_pose = ("photo" in args.train_mode)
# args.pretrained = not args.no_pretrained
args.result = os.path.join('..', 'result/v4')
