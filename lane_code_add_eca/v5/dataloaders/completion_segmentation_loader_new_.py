...
def get_paths_and_transform(split, args):
    ...
    if split == "train":
        ...
        glob_pc = os.path.join(
            ...
            '/home/first/桌面/gongyan/small_data/val/knn_pc/*.png'
        )
        ...
        glob_road_label = os.path.join(
            ...
            '/home/first/桌面/gongyan/small_data/val/road_label/*.png'
        )
        ...
        glob_lane_label = os.path.join(
            args.data_folder,
            #'data_depth_annotated/train/*_sync/proj_depth/groundtruth/image_0[2,3]/*.png'
            '/home/first/桌面/gongyan/small_data/val/lane_label/*.png'
        )
        
        # 4、
        glob_rgb = os.path.join(
                args.data_folder,
                '/home/first/桌面/gongyan/small_data/val/train_image_2_lane/*.png'
            )
...
#             return pnew
        ...
        if args.val == "select":
            ...
            glob_pc = os.path.join(
                args.data_folder,
                #'data_depth_velodyne/train/*_sync/proj_depth/velodyne_raw/image_0[2,3]/*.png'
                # '/home/linux/data/new_data/small_data/test/knn_pc/*.png'
                '/home/first/桌面/gongyan/small_data/val/knn_pc/*.png'
            )
            ...
            glob_road_label = os.path.join(
                args.data_folder,
                #'data_depth_annotated/train/*_sync/proj_depth/groundtruth/image_0[2,3]/*.png'
                # '/home/linux/data/new_data/small_data/test/road_label/*.png'
                '/home/first/桌面/gongyan/small_data/val/road_label/*.png'
            )
            ...
            glob_lane_label = os.path.join(
                args.data_folder,
                #'data_depth_annotated/train/*_sync/proj_depth/groundtruth/image_0[2,3]/*.png'
                # '/home/linux/data/new_data/small_data/test/lane_label/*.png'
                '/home/first/桌面/gongyan/small_data/val/lane_label/*.png'
            )
            ...
            glob_rgb = os.path.join(
                    args.data_folder,
                    # '/home/linux/data/new_data/small_data/test/train_image_2_lane/*.png'
                    '/home/first/桌面/gongyan/small_data/val/train_image_2_lane/*.png'
                )       
